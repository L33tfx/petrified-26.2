...
public class TerracottaSoldierEyesModel<S extends FabricRenderState> extends Model<S> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition eyes = head.addOrReplaceChild("eyes", CubeListBuilder.create().texOffs(9, 14).addBox(-3.0F, -26.0F, -4.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(13, 14).addBox(1.0F, -26.0F, -4.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, 22.0F, 8.0F));
